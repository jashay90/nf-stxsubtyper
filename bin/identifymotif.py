...
parser.add_argument('-k', dest='knownseq', default='Stx2c_302_2', help="""title of reference sequence in fasta file""")
...
# infile = "muscleout.fasta" # adding 4 to the last 3 sites to account for the XXXX
sitesoi = {312: {"S": ["a", "d"], "F": ["a", "c"]}, 318: {"E": ["a", "d"], "K": ["a", "c"]}, 356: {"E": ["a", "c", "d"]}, 357: {"D": ["a"], "N": ["c", "d"]}, 358: {"D": ["a", "c", "d"]}} # remember 0-based index for keys. Is a dataframe better here?
